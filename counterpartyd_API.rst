...
- Set it up manually, using the instructions `here <https://github.com/CounterpartyXCP/Documentation/blob/master/installation.rst>`_
- For Windows and Ubuntu Linux users, you can use the `automated build system <https://github.com/CounterpartyXCP/Documentation/blob/master/build_counterpartyd.rst>`_
