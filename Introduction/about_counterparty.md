...
The Counterparty protocol (and its internal token XCP) was launched in January 2014 without raising any funds. Its first introduction to the world was a release of working source code. To learn more about the internal token of Counterparty, [read about XCP](about_xcp.md).
